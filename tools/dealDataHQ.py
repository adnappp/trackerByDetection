...
pre_path='/home/dengta/faster-rcnn/my-tf-faster-rcnn-simple'
...
def deal():
    for i in list:
        ...
        if j != 0: #3:2
           ...
           k = (i % 12)
           if k == 1 or k == 4 or k==7 or k==10 or k==11:
              ftrain.write(name)
           else:
              fval.write(name)
        else:
...
if __name__ == "__main__":
    ...
    _classes = ['__background__',  # always index 0
                     '1']
    id_file = open(os.path.abspath("..")+'/ids.txt', 'r')

    for line in id_file.readlines():
        line = line.strip()
        _classes.append(line)
